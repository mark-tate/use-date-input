...
import { DemoContent, DemoContentSmall } from "../../gatsby-theme-docz/components/DemoContent";
...
{() => {
    ...
    const AddYourComponentHere = isSmallBreakpoint ? DemoContentSmall : DemoContent; 
